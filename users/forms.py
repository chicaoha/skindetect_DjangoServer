...
class ProfileForm(forms.ModelForm): 
    ...
    gender = forms.ChoiceField(label='Gender', choices=[('Male', 'Male'), ('Female', 'Female'), ('Other', 'Other')], required=False, widget=forms.Select(attrs={'class': 'w-full rounded-md border border-stroke bg-white py-3 px-3 text-base font-medium text-body outline-none focus:border-primary focus:shadow-input dark:border-stroke-dark dark:bg-black dark:text-white dark:focus:border-primary', 'aria-label': 'Gender select example'}))
